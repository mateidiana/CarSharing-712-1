...
Car::Car(string licensePlate, string model, string brand, int firstRegistrationYear, int mileage, double dailyPrice,
         string fuelType, string transmission, string color, string remark)
        : licensePlate(move(licensePlate)), model(move(model)), brand(move(brand)),
          firstRegistrationYear(firstRegistrationYear), mileage(mileage), dailyPrice(dailyPrice),
          fuelType(move(fuelType)), transmission(move(transmission)), color(move(color)), remark(move(remark)) {}
